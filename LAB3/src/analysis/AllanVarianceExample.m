...
StationaryData = rosbag('Z:\RSN\Bagfiles_LAB3\rosbag_imu_10172022_5h.bag');
...
omega = cellfun(@(m) double(m.IMU.AngularVelocity.Z),msgStructs_StationaryData);
Fs = 40;
%load('Z:\RSN\Bagfiles_LAB3\IMUdata_5hrs.bag', 'omega', 'Fs')
t0 = 1/Fs;
%%
% 
